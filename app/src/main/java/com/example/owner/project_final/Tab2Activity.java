...
/**
 * 2019.03.15 04:36
 * Toolbar, Navigation Drawer 작동 안함
 */
...
//        tab3act.finish();
        ...
        /*/ For Navigation Drawer -------------------------------------------------------------------
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_tab2);  //각 레이아웃의 가장 큰 DrawerLayout 이름
        navigationView = (NavigationView)findViewById(R.id.navigationView_tab2);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    case R.id.navi_tab1:    //오늘 하루
                        Toast.makeText(Tab2Activity.this, item.getTitle(), Toast.LENGTH_LONG).show();
                    ...
                    case R.id.navi_tab3_1:    //공동구매 게시판
                        Toast.makeText(Tab2Activity.this, item.getTitle(), Toast.LENGTH_LONG).show();
                        intent = new Intent().setClass( Tab2Activity.this, PurchaseActivity.class );
                        startActivity(intent);
                        break;
                    case R.id.navi_tab3_2:    //단기방대여 게시판
                        Toast.makeText(Tab2Activity.this, item.getTitle(), Toast.LENGTH_LONG).show();
                        intent = new Intent().setClass( Tab2Activity.this, RoomActivity.class );
                        startActivity(intent);
                        break;
/*
...
* /
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        drawerLayout = (DrawerLayout)findViewById(R.id.activity_tab2);  //각자에 맞는 레이아웃의 가장 겉 DrawerLayout 이용할 것
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_logout:
                ...
                intent = new Intent().setClass( Tab2Activity.this, LoginActivity.class );
                startActivity(intent);
                overridePendingTransition(0, 0);
                return true;
