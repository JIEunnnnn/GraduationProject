...
public class PurchaseWriteActivity extends AppCompatActivity {
    ...
    public void save(View view) {
        ...
        String autoKey = FirebaseDatabase.getInstance().getReference().child(PublicVariable.FIREBASE_CHILD_PURCHASES).push().getKey();
        final String storageKey = FirebaseDatabase.getInstance().getReference().child(PublicVariable.FIREBASE_CHILD_PURCHASES).push().getKey();
        PurchaseWrite purchaseWrite = new PurchaseWrite(FirebaseApi.getCurrentUser().getUid(), editTitle.getText().toString(), editUser.getText().toString(),
                editTradeDate.getText().toString(), editTradeTime.getText().toString(), editCost.getText().toString(), tradeItem.getText().toString(),
        ...
        databaseReference.child(PublicVariable.FIREBASE_CHILD_PURCHASES).child(FirebaseApi.getCurrentUser().getUid()).child(autoKey).setValue(purchaseWrite).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
                    ...
                    for (int i = 0; i < storePhotoArray.size(); i++) {
                        FirebaseApi.sendFirebaseStorage(storageKey, storePhotoArray.get(i), i, storePhotoArray.size(), new OnPhotoResultListener() {
                            ...
                            public void onComplete() {
                                ...
                                new AlertDialog.Builder(PurchaseWriteActivity.this, R.style.Theme_AppCompat_Light_Dialog)
                                        .setTitle("알림")
    ...
    public void requestAddress(View view) {
        ...
        Dexter.withActivity(PurchaseWriteActivity.this).withPermissions(Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION).withListener(new MultiplePermissionsListener() {
            @Override
    ...
    public void setStartDay(View view) {
        ...
        if (!isFinishing()) {
            ...
            DatePickerDialog dialog = new DatePickerDialog(PurchaseWriteActivity.this, new DatePickerDialog.OnDateSetListener() {
                @Override
    ...
    public void setEndDay(View view) {
        ...
        if (!isFinishing()) {
            ...
            TimePickerDialog dialog = new TimePickerDialog(PurchaseWriteActivity.this, new TimePickerDialog.OnTimeSetListener() {
                @Override
    ...
    public void setPhotoClick_01(View view) {
        Dexter.withActivity(PurchaseWriteActivity.this).withPermissions(Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
            public void onPermissionsChecked(MultiplePermissionsReport report) {
                if (report.areAllPermissionsGranted()) {
                    mPhotoPosition = 0;
